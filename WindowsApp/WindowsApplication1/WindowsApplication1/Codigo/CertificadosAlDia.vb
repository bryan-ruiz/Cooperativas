...
Public Class CertificadosAlDia
    ...
    Public Sub consultar()
        ...
        Else
            Try
                ...
                If valores.Count <> 0 Then
                    VCertificadosPonerseAlDia.CertificadosAlDiaTextboxNombre.Text = valores(0) + " " + valores(1) + " " + valores(2)
                    VCertificadosPonerseAlDia.CertificadosAlDiaTextboxCed.Text = valores(4)
                    VCertificadosPonerseAlDia.CertificadosAlDiaTextboxNumAsociado.Text = valores(5)
                    VCertificadosPonerseAlDia.CertificadosAlDiaTextboxAcumAnterior.Text = valores(16)
                    VCertificadosPonerseAlDia.CertificadosAlDiaTextboxTotalPeriodo.Text = valores(17)

                Else
                    MessageBox.Show(variablesGlobales.noExistenDatos, "", MessageBoxButtons.OK, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button1)
                    VCertificadosPonerseAlDia.CertificadosAlDiaTextboxCedulaNumAsociado.Text = ""
                End If
    ...
    'suma el monto al acumulado x socio
    Public Sub actualizarSumarAlAcumAnteriorXSocio()
        Dim cedula As String = VCertificadosPonerseAlDia.CertificadosAlDiaTextboxCed.Text
        Dim montoASumar As String = VCertificadosPonerseAlDia.CertificadosAlDiaTextBoxMontoSumar.Text
        ...
        Try
            ...
            BD.ConectarBD()
            Dim hecho As Integer = BD.actualizarSumarAlAcumAnteriorXSocio(cedula, Convert.ToInt32(montoASumar))
            BD.CerrarConexion()
    ...
    Public Sub limpiar()
        VCertificadosPonerseAlDia.CertificadosAlDiaTextboxCedulaNumAsociado.Text = ""
        VCertificadosPonerseAlDia.CertificadosAlDiaTextboxNombre.Text = ""
        VCertificadosPonerseAlDia.CertificadosAlDiaTextboxAcumAnterior.Text = ""
        VCertificadosPonerseAlDia.CertificadosAlDiaTextboxTotalPeriodo.Text = ""
        VCertificadosPonerseAlDia.CertificadosAlDiaTextboxCed.Text = ""
        VCertificadosPonerseAlDia.CertificadosAlDiaTextBoxMontoSumar.Text = ""
        VCertificadosPonerseAlDia.CertificadosAlDiaTextboxNumAsociado.Text = ""
    End Sub
