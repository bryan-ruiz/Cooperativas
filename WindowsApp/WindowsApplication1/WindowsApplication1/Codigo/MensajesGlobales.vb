...
Public Class MensajesGlobales
    ...
    Public reservasSumadasConExito As String = "Éxito al sumar las reservas!"
    Public exitoGenerarExcEnTransito As String = "Éxito al generar excedentes en tránsito!"
    Public exitoGenerarCertEnTransito As String = "Éxito al generar certificados en tránsito!"

    'Mensajes Error
    Public errorBorrarExcEnTransito As String = "Error al borrar los excedentes en tránsito"
    Public errorBorrarCertEnTransito As String = "Error al borrar los certificados en tránsito"
    Public errorGenerarCertEnTransito As String = "Error al generar los certificados en tránsito"
    Public errorGenerarExcEnTransito As String = "Error al generar los excedentes en tránsito"
    Public errorSumandoTractosParaTodosAsociados As String = "Error al sumar los tractos para todos los Asociados"
    Public errorSumandoReservas As String = "Error al sumar las reservas en el Sistema"
    ...
    Public errorProveedorNoExiste As String = "Error, el Proveedor no se encuentra en el sistema realizar la acción"
