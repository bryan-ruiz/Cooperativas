...
Public Class ReservasEntradas
    ...
    Public Sub obtenerDatosSeleccionarReserva()
        Try
            ...
            If listaDeReservas.Count <> 0 Then
                estado = True
                VReservasEntradas.ComboBox_IngresosCodigCuenta.Items.Clear()
                Dim contador As Integer = 0
                Dim conta As Integer = 0
                While listaDeReservas.Count > contador
                    VReservasEntradas.ComboBox_IngresosCodigCuenta.Items.Add(listaDeReservas(contador).nombre)
                    conta += 1
                    contador = contador + 1
                End While
                If conta = 0 Then
                    ...
                    VReservasEntradas.ComboBox_IngresosCodigCuenta.Items.Clear()
                    VReservasEntradas.ComboBox_IngresosCodigCuenta.Items.Add("No se poseen cuentas")
                End If
            Else
                estado = False
                VReservasEntradas.ComboBox_IngresosCodigCuenta.Items.Clear()
    ...
    Public Sub limpiar()
        VReservasEntradas.CertificadosEntradasTextboxFacturaRecibos.Text = ""
        VReservasEntradas.CertificadosEntradasTexboxCliente.Text = ""
        VReservasEntradas.CertificadosEntradasDescripcion.Text = ""
        VReservasEntradas.CertificadosEntradasCantidad.Text = ""
        VReservasEntradas.CertificadosEntradasPrecioUnitario.Text = ""
        VReservasEntradas.CertificadosEntradasTotal.Text = ""
    End Sub

    Public Sub calcularTotal()
        Try
            Dim cantidad As Integer = Integer.Parse(VReservasEntradas.CertificadosEntradasCantidad.Text)
            Dim precioUnitario As Integer = Integer.Parse(VReservasEntradas.CertificadosEntradasPrecioUnitario.Text)

            Dim resultado As Integer = cantidad * precioUnitario
            'Format ¢ 1,000.00
            '¢ + Dim stringTotal As String = resultado.ToString("N")

            VReservasEntradas.CertificadosEntradasTotal.Text = resultado
    ...
    Public Sub insertarReservaEntrada()

        Dim valores As Integer

        Dim fecha As String = VReservasEntradas.CertificadosEntradasFecha.Text
        Dim factura As String = VReservasEntradas.CertificadosEntradasTextboxFacturaRecibos.Text
        Dim cliente As String = VReservasEntradas.CertificadosEntradasTexboxCliente.Text
        Dim descripcion As String = VReservasEntradas.CertificadosEntradasDescripcion.Text
        Dim cantidad As String = VReservasEntradas.CertificadosEntradasCantidad.Text
        Dim precioUnitario As String = VReservasEntradas.CertificadosEntradasPrecioUnitario.Text
        Dim total As String = VReservasEntradas.CertificadosEntradasTotal.Text
        Dim codCuenta As String = VReservasEntradas.ComboBox_IngresosCodigCuenta.Text
        ...
        facturaReciboYaExiste = validarNoExistenFacturasRepetidasrReservasEntradas(factura)
        If facturaReciboYaExiste <> 0 Then
            ...
            VReservasEntradas.CertificadosEntradasTextboxFacturaRecibos.Text = ""
            VReservasEntradas.CertificadosEntradasTextboxFacturaRecibos.Select()
            Return
        End If

        Try
            BD.ConectarBD()
            valores = BD.insertarReservasEntradas(fecha, cliente, descripcion, cantidad, precioUnitario, total, codCuenta, factura)
            If valores <> 0 Then
                limpiar()
                ...
                BD.insertarMontoEnReserva(total, codCuenta)
    ...
    Function validarNoExistenFacturasRepetidasrReservasEntradas(ByVal factura As String) As Integer
        ...
        Try
            ...
            facturasRepetidas = BD.obtenerReservasEntradasPorFactura(factura)
