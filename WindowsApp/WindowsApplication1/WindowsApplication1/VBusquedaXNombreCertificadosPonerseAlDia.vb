...
Public Class VBusquedaXNombreCertificadosPonerseAlDia
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView1.DoubleClick
        ...
        Try
            ...
            VCertificadosPonerseAlDia.CertificadosAlDiaTextboxCedulaNumAsociado.Text = numAsociado
            'Call VAsociados.ButtonAsociadosBuscar_Click(sender, e)
            Call VCertificadosPonerseAlDia.CertificadosAlDiaButtonConsultar_Click(sender, e)
