...
Public Class ConexionBD
    ...
    Sub ConectarBD()
        Try
            ...
            objConexion = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;" + "Data Source =" & "C:/BD/BDConsultasMed.mdb;Jet OLEDB:Database Password=C454gr154;")
    ...
    Function obtenerReportePacientes(ByVal tipoReporte As String) As List(Of SocioClase)
        Dim MyList As New List(Of SocioClase)
        Try
            If tipoReporte = "Activos" Then
                SQL = "SELECT SOCIOS.* 
