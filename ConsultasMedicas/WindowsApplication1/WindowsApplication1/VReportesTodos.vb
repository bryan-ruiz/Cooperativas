Public Class VReportesTodos
    ...
    Private Sub ReporteEntradaDeAportacionesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteEntradaDeAportacionesToolStripMenuItem.Click
    ...
    Private Sub ReporteSaldosDeEntradaDeAportacionesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteSaldosDeEntradaDeAportacionesToolStripMenuItem.Click
    ...
    Private Sub ReporteSalidaDeAportacionesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteSalidaDeAportacionesToolStripMenuItem.Click
        certificadoEntrada.generarReporteAportaciones()
        Print.Show()
        Print.abrirReporte(variablesGlobales.pathReporteAportaciones)
        Me.Close()
    ...
    Private Sub ReporteSaldosDeSalidasDeAportacionesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReporteSaldosDeSalidasDeAportacionesToolStripMenuItem.Click
        certificadoEntrada.generarReporteSaldosDeAportaciones()
        Print.Show()
        Print.abrirReporte(variablesGlobales.pathreporteDeSaldosDeAportaciones)
        Me.Close()
