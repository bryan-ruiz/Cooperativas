...
Public Class Reservas
    ...
    Public Sub realizarCierrePeriodo()
        ...
        'Pasa de decimal 1000.5 a entero 1000
        Dim mitadAfiliaciones As Integer = Convert.ToInt32((cantidadAfuliaciones / 100) * 50)


        'Suma 50% de las afiliaciones en la reserva de Educacion y 50% en Bienestar Social
        valores5 = actualizarMontoEnBase(mitadAfiliaciones.ToString, "Educacion")
        valores6 = actualizarMontoEnBase(mitadAfiliaciones.ToString, "BienestarSocial")
        ...
        BD.ConectarBD()
        Dim totalASumar As String = mitadAfiliaciones.ToString
        ...
        If valores1 <> 0 And valores2 <> 0 And valores3 <> 0 And valores4 <> 0 And valores7 <> 0 Then
            MessageBox.Show(variablesGlobales.reservasSumadasConExito, " ", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
        Else
            MessageBox.Show(variablesGlobales.errorSumandoReservas, " ", MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1)
        End If
    End Sub
    ...
    Public Sub borrarExcedentesEnTransito()
        ...
        Catch ex As Exception
            MsgBox(variablesGlobales.errorBorrarExcEnTransito)
        End Try
    ...
    Public Sub borrarCertificadosEnTransito()
        Try
            ...
            BD.CerrarConexion()
        Catch ex As Exception
            MsgBox(variablesGlobales.errorBorrarCertEnTransito)
        End Try
    ...
    Public Sub GenerarExcedentesEnTransito()
        ...
        Try
            ...
            MessageBox.Show(variablesGlobales.exitoGenerarExcEnTransito, "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)
        Catch ex As Exception
            MessageBox.Show(variablesGlobales.errorGenerarExcEnTransito)
        End Try
    End Sub
    ...
    Public Sub GenerarCertificadosEnTransito()
        ...
        Try
            ...
            End While
            MessageBox.Show(variablesGlobales.exitoGenerarCertEnTransito, "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1)

        Catch ex As Exception
            MessageBox.Show(variablesGlobales.errorGenerarCertEnTransito)
        End Try
    End Sub
