...
Public Class Saldos
    ...
    Public Sub generarReporteSaldosNuevo()
        ...
        Try
            ...
            Dim pdfWrite As PdfWriter = PdfWriter.GetInstance(pdfDoc, New FileStream(variablesGlobales.pathReporteSaldos, FileMode.Create))
            pdfDoc.Open()
            ...
            Print.Show()
            Print.abrirReporte(variablesGlobales.pathReporteSaldos)
