...
Public Class VBusquedaIngresoXProveedor
    ...
    Public Sub Retrieve()
        ...
        'SQL STMT
        Dim sql As String = "SELECT INGRESOS.fecha, INGRESOS.reciboFactura, INGRESOS.cliente, INGRESOS.codigoDeCuenta, INGRESOS.descripcion
                                FROM [INGRESOS] "
    ...
    'POPULATE
    Private Sub Populate(fecha As String, factura As String, proveedor As String, codigoCuenta As String, descripcion As String)
        'ROW ARRAY
        Dim row As String() = New String() {fecha, factura, proveedor, codigoCuenta, descripcion}
